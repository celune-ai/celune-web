...
export function PixelGrid({
  ...
  useEffect(() => {
    ...
    // Respect reduced motion preference — render static grid, skip animations
    ...
    if (prefersReducedMotion) {
      // Render one static frame with all pixels fully revealed, no glow
      mountTimeRef.current = -100_000; // force all pixels to be fully revealed
      draw();
