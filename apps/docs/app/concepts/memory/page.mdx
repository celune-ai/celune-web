...
- **Manually via MCP** — using the `celune_remember` tool in Claude Code.
...
celune_recall: "What do I need to do before deploying?"
```
...
- [MCP Setup](/guides/mcp-setup) — How to use `celune_remember` and `celune_recall` from Claude Code.
