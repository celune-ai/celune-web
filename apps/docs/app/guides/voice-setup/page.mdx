...
- **Plan**: Voice mode is available on **Pro**, **Unlimited**, and **Enterprise** plans. It is not available on Builder (free).
...
- Confirm your plan includes voice mode - Builder (free) does not.
