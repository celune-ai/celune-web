      ...
      {agents.map((a, i) => (
        ...
        >
          ...
          <span
            ...
            style={{ color: i === 0 ? a.color : 'rgba(255,255,255,0.5)' }}
          >
            {a.id}
          </span>
...
function ToolUseIllustration() {
  const tools = [
    ...
    },
    {
      ...
      icon: (
        <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
          <path d="M13.7 21.8c-.4.5-1.3.2-1.3-.5V13h8.3c.8 0 1.3.9.7 1.5l-7.7 7.3zM10.3 2.2c.4-.5 1.3-.2 1.3.5V11H3.3c-.8 0-1.3-.9-.7-1.5l7.7-7.3z" />
        </svg>
      ),
    },
    {
      ...
      icon: (
        <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
          <path d="M15.852 8.981h-4.588V0h4.588c2.476 0 4.49 2.014 4.49 4.49s-2.014 4.491-4.49 4.491zM12.735 7.51h3.117c1.665 0 3.019-1.355 3.019-3.019s-1.354-3.019-3.019-3.019h-3.117V7.51zm0 13.01h-4.588c-2.476 0-4.49-2.014-4.49-4.49s2.014-4.49 4.49-4.49h4.588v8.98zm-4.588-7.51c-1.665 0-3.019 1.355-3.019 3.02s1.354 3.019 3.019 3.019h3.117V13.01h-3.117zm4.588-5.51h-4.588c-2.476 0-4.49-2.014-4.49-4.49S5.671 0 8.147 0h4.588v7.51zm-4.588-6.04c-1.665 0-3.019 1.355-3.019 3.02s1.354 3.019 3.019 3.019h3.117V1.47h-3.117zM8.147 15.989c-2.476 0-4.49-2.014-4.49-4.49s2.014-4.49 4.49-4.49 4.49 2.014 4.49 4.49-2.014 4.49-4.49 4.49zm0-7.51c-1.665 0-3.019 1.354-3.019 3.02s1.354 3.019 3.019 3.019 3.019-1.354 3.019-3.02-1.354-3.019-3.019-3.019z" />
        </svg>
      ),
    },
    {
      ...
      icon: (
        <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
          <path d="M2.886 10.32a10.18 10.18 0 001.67 4.128l6.272-6.272H4.056a10.13 10.13 0 00-1.17 2.144zm.603-3.258h9.449L3.49 16.51A10.2 10.2 0 012 12c0-1.758.447-3.413 1.233-4.859l.256-.079zM12 2c5.523 0 10 4.477 10 10s-4.477 10-10 10a9.954 9.954 0 01-6.294-2.236l12.058-12.058A9.953 9.953 0 0112 2z" />
        </svg>
      ),
    },
    {
    ...
    },
    {
      ...
      icon: (
        <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
          <path d="M4.459 4.208c.746.606 1.026.56 2.428.466l13.215-.793c.28 0 .047-.28-.046-.326L18.29 2.17c-.466-.373-.84-.186-1.633-.14L3.667 2.96c-.466.047-.56.28-.373.466l1.165.782zm.793 3.36v13.904c0 .747.373 1.027 1.214.98l14.523-.84c.84-.046.933-.56.933-1.166V6.63c0-.606-.233-.933-.746-.886l-15.177.886c-.56.047-.747.327-.747.933zm14.337.745c.093.42 0 .84-.42.886l-.7.14v10.264c-.607.327-1.166.514-1.633.514-.746 0-.933-.234-1.493-.934l-4.571-7.186v6.953l1.446.327s0 .84-1.166.84l-3.22.186c-.093-.186 0-.653.327-.746l.84-.233V9.854L7.822 9.62c-.093-.42.14-1.026.793-1.073l3.453-.233 4.757 7.28v-6.44l-1.213-.14c-.093-.514.28-.886.747-.933l3.227-.186z" />
        </svg>
      ),
    },
    {
    ...
    },
    {
      ...
      icon: (
        <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
          <path d="M2 4h14v2H4v12h12v-5h2v7H2V4zm18 0h2v8h-2V6.414l-8.293 8.293-1.414-1.414L18.586 5H14V4h6z" />
        </svg>
      ),
    },
    {
  ...
  return (
    <div className="flex h-full flex-col px-5 pt-5">
      <div className="mb-4 flex items-center gap-2 border-b border-white/[0.06] pb-2.5">
        <span className="font-mono text-[9px] tracking-wider text-neutral-600 uppercase">
          MCP Integrations
        </span>
        <span className="bg-celune-500/15 text-celune-400 ml-auto rounded px-1.5 py-0.5 text-[9px] font-medium">
          50+
        </span>
      </div>
...
function PersistentMemoryIllustration() {
  const memories = [
    {
      type: 'Decision',
      text: 'Use SSE over WebSockets for dashboard',
      time: '2m ago',
      active: true,
    },
    {
      type: 'Pattern',
      text: 'Team prefers Zod for validation schemas',
      time: '1h ago',
      active: false,
    },
    {
      type: 'Context',
      text: 'Auth system uses JWT with refresh tokens',
      time: '3h ago',
      active: false,
    },
    {
      type: 'Feedback',
      text: 'Keep PR descriptions under 3 paragraphs',
      time: '1d ago',
      active: false,
    },
    {
      type: 'Decision',
      text: 'Rate limit auth endpoints at 100 req/min',
      time: '2d ago',
      active: false,
    },
    {
      type: 'Pattern',
      text: 'Use server actions for form mutations',
      time: '3d ago',
      active: false,
    },
    {
      type: 'Context',
      text: 'Staging deploys to preview.celune.ai',
      time: '4d ago',
      active: false,
    },
    {
      type: 'Feedback',
      text: 'Always add migration rollback scripts',
      time: '5d ago',
      active: false,
    },
  ];
      ...
      {memories.map((m) => (
        ...
        >
          <div className="flex items-center gap-1.5">
            <span className="rounded bg-white/[0.06] px-1 py-0.5 text-[8px] font-medium text-neutral-500">
              {m.type}
            </span>
...
function SkillLibraryIllustration() {
  const skills = [
    ...
    {
      name: '/slack',
      icon: 'M5 10V8a1 1 0 112 0v2a1 1 0 01-2 0zM9 6V8a1 1 0 102 0V6a1 1 0 00-2 0zM6 5H8a1 1 0 100-2H6a1 1 0 000 2zM10 11H8a1 1 0 100 2h2a1 1 0 000-2z',
    },
      ...
      {tasks.map((t) => (
        <div
          ...
          style={{
            ...
            backgroundColor:
              t.status === 'done' ? 'rgba(34,197,94,0.03)' : 'rgba(255,255,255,0.02)',
          }}
        >
          {t.status === 'done' ? (
          ...
          <span
            className="text-[11px]"
            style={{
              color: t.status === 'done' ? 'rgba(255,255,255,0.6)' : 'rgba(255,255,255,0.3)',
            }}
          >
            {t.label}
          </span>
      ...
      <div className="rounded-lg border border-white/[0.06] bg-white/[0.02] p-2">
        {lines.map((l, i) => (
          <div
            ...
            style={{ backgroundColor: l.type === 'add' ? 'rgba(34,197,94,0.04)' : 'transparent' }}
          >
            <span
              className="w-3 text-right font-mono text-[9px]"
              style={{ color: l.type === 'add' ? '#22c55e' : 'transparent' }}
            >
              +
            </span>
            <span
              className="font-mono text-[9px]"
              style={{ color: l.type === 'add' ? 'rgba(34,197,94,0.7)' : 'rgba(255,255,255,0.25)' }}
            >
              {l.text}
            </span>
          </div>
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span
              ...
              style={{ color: e.status === 'active' ? e.color : 'rgba(255,255,255,0.25)' }}
            >
              <span
                className="h-1 w-1 rounded-full"
                style={{
                  backgroundColor: e.status === 'active' ? e.color : 'rgba(255,255,255,0.15)',
                }}
              />
              {e.status}
            </span>
          ...
          <div className="mt-1.5 flex gap-1">
            <span className="rounded bg-white/[0.04] px-1 py-0.5 text-[8px] text-neutral-600">
              isolated
            </span>
            <span className="rounded bg-white/[0.04] px-1 py-0.5 text-[8px] text-neutral-600">
              reproducible
...
const FEATURES = [
  ...
  },
  {
    ...
    description:
      'Semantic recall with pgvector. Agents remember decisions and patterns across sessions.',
...
export function CeluneFeatureCards() {
  ...
  return (
    <section id="platform" className="relative z-[1] overflow-hidden py-12 md:py-32">
      ...
      >
        {LOOP_ITEMS.map((card, i) => (
          <div
            key={`${card.title}-${i}`}
            data-card
            className="flex w-[calc(100vw-2rem)] flex-none snap-center flex-col overflow-hidden border border-white/[0.06] bg-transparent md:w-[calc((min(100vw,96rem)-3rem)/3)]"
          >
            {/* Text */}
            <div className="px-6 pt-6 pb-0">
              <h3 className="font-heading text-[20px] font-medium text-white">{card.title}</h3>
              <p className="mt-2 text-[16px] leading-snug text-neutral-500">{card.description}</p>
            </div>
