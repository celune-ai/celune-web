...
export function CeluneNav() {
  ...
  return (
    <nav
      className={cn(
        'fixed top-0 right-0 left-0 z-50 border-b border-dashed border-white/[0.08] transition-all duration-300',
        scrolled ? 'bg-[#08080A]/90 backdrop-blur-xl' : 'bg-transparent',
      )}
    >
      ...
      {mobileOpen && (
        <div
          id="mobile-nav-menu"
          className="border-t border-dashed border-white/[0.06] bg-[#08080A]/95 backdrop-blur-xl md:hidden"
        >
