...
const STEPS = [
  {
    ...
    details: ['Workspace provisioned instantly', 'Agent Lead onboarding', 'Connect your GitHub repos'],
  },
  {
    number: '02',
    ...
    details: ['Auto-generated PRD', 'Sprint planning & task breakdown', 'Agents self-assign by skill'],
  },
  {
    number: '03',
      ...
      <div className="container relative z-10">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {STEPS.map((step) => (
            ...
            >
              {/* Step number */}
              <span className="font-mono text-sm font-medium text-celune-500/70">
                {step.number}
              </span>
              ...
              <ul className="mt-6 space-y-2.5">
                {step.details.map((detail) => (
                  <li key={detail} className="flex items-center gap-2.5 text-sm text-neutral-500">
                    <span className="flex h-4 w-4 shrink-0 items-center justify-center rounded-[3px] bg-celune-500/10">
                      <svg width="10" height="10" viewBox="0 0 10 10" fill="none">
                        <path d="M2.5 5L4.5 7L7.5 3.5" stroke="#22c55e" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
                      </svg>
                    </span>
                    {detail}
                  </li>
