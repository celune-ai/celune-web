  ...
  return (
    <div className="relative mx-auto h-[320px] w-[320px]">
      ...
      <motion.div
        ...
        className="border-border absolute inset-[20px] rounded-full border border-dashed"
      />
      ...
      <motion.div
        ...
        className="border-celune-500/20 absolute top-1/2 left-1/2 h-[200px] w-[200px] -translate-x-1/2 -translate-y-1/2 rounded-full border"
      />
    </div>
  );
}
