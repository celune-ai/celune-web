    ...
    <div className="mx-auto max-w-3xl px-6 py-24 text-neutral-300">
      ...
      <div className="space-y-8 text-sm leading-relaxed">
        <section>
          ...
          <p>
            By accessing or using Celune, you agree to be bound by these Terms of Service. If you do
        ...
        <section>
          ...
          <p>
            Celune provides an agentic engineering platform that deploys autonomous AI agents to
            write code, manage tasks, and run development pipelines. The service includes a web
            dashboard, API access, and integrations with third-party tools.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            be at least 18 years old to use Celune. You are responsible for all activity that occurs
            under your account, including actions taken by AI agents you configure.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Paid plans are billed monthly. You can cancel at any time. Cancellation takes effect at
            the end of the current billing period. Refunds are not provided for partial months.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Celune is provided &quot;as is&quot; without warranties of any kind. We are not liable
            for any damages arising from your use of the service, including but not limited to code
            generated by AI agents. You are responsible for reviewing and testing all
        ...
        <section>
          ...
          <p>
            ...
            your right to use the service ceases immediately. You may export your data before
            termination.
          </p>
        </section>
