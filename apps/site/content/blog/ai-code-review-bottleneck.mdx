...
<ProductScreenshot src="/blog/screenshots/code-review.jpg" alt="Celune's PR review interface showing inline AI-generated comments catching logic errors and security issues" width={1200} height={750} layout="full" caption="AI review in action — the SCAN agent leaves inline comments on every PR, flagging logic gaps and security patterns before a human ever looks at the code." />
...
<ProductScreenshot src="/blog/screenshots/agent-config.jpg" alt="Celune agent team configuration showing RICK, SAGE, NOIR, SCAN, and DELV agent cards with their roles and model assignments" width={1200} height={750} layout="float-right" caption="SCAN is one of five specialized agents — each with a defined role and model tier." />
