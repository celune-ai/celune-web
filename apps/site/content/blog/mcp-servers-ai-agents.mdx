...
<ProductScreenshot src="/blog/screenshots/agent-config.jpg" alt="Celune agent configuration panel showing RICK, SAGE, NOIR, SCAN, and DELV agents with their MCP tool access and model assignments" width={1200} height={750} layout="full" caption="Each Celune agent gets access to specific MCP servers based on its role — RICK gets Supabase and GitHub, SAGE gets Slack and Gmail." />
...
<ProductScreenshot src="/blog/screenshots/dashboard.jpg" alt="Celune system health dashboard showing connected services, uptime metrics, and agent activity across MCP-integrated tools" width={1200} height={750} layout="float-right" caption="The dashboard shows the compound effect — agents working across Supabase, Slack, and GitHub through MCP, all visible in one place." />
