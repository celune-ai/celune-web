...
<ProductScreenshot
  ...
  alt="Celune cost analytics dashboard showing per-agent cost breakdown and model usage distribution"
  width={1200}
  height={750}
  layout="full"
  caption="Per-agent cost tracking in Celune — see exactly where your AI spend is going and which optimizations are working."
/>
...
<ProductScreenshot
  ...
  alt="Celune system health dashboard with real-time metrics, usage charts, and activity feed"
  width={1200}
  height={750}
  layout="float-right"
  caption="The usage dashboard surfaces cost-per-agent trends so you can catch bloat before it hits your invoice."
/>
