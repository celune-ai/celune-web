...
<ProductScreenshot src="/blog/screenshots/task-board.jpg" alt="Celune kanban task board showing Inbox, In Progress, and Done columns with agent-assigned tasks" width={1200} height={750} layout="full" caption="The morning starts here — reviewing overnight agent output on the shared task board." />
...
<ProductScreenshot src="/blog/screenshots/agent-config.jpg" alt="Celune agent team configuration showing cards for RICK, SAGE, NOIR, SCAN, and DELV agents with their roles and model assignments" width={1200} height={750} layout="float-right" caption="Each agent has a defined role and model tier — the team that runs my one-person startup." />
