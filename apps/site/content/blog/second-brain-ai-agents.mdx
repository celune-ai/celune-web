...
<ProductScreenshot src="/blog/screenshots/memory-system.jpg" alt="Celune agent memory system showing categorized memory entries organized by type — user preferences, project facts, feedback, and references" width={1200} height={750} layout="full" caption="The memory system in action — categorized entries that persist across sessions and are shared across the entire agent team." />
...
<ProductScreenshot src="/blog/screenshots/dashboard.jpg" alt="Celune system health dashboard showing agent activity metrics and knowledge base monitoring" width={1200} height={750} layout="float-right" caption="Monitoring your second brain's health — track agent activity, memory growth, and system status in one view." />
