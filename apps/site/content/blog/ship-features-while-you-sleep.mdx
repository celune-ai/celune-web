...
<ProductScreenshot
  ...
  alt="Celune kanban task board showing Inbox, In Progress, and Done columns with sprint-ordered tasks"
  width={1200}
  height={750}
  layout="full"
  caption="The overnight build works through sprint-ordered tasks on the Celune task board — each task scoped, assigned, and tracked."
/>
...
<ProductScreenshot
  ...
  alt="Celune system health dashboard showing uptime metrics, response charts, and recent activity feed"
  width={1200}
  height={750}
  layout="full"
  caption="The morning after — the system dashboard shows what happened overnight, with metrics, activity feed, and build health at a glance."
/>
...
<ProductScreenshot
  src="/blog/screenshots/cost-tracking.jpg"
  alt="Celune cost analytics showing per-agent token spend and model usage breakdown"
  width={1200}
  height={750}
  layout="float-right"
  caption="Every overnight session tracks per-agent costs so you know exactly what the build spent."
/>
