...
<ProductScreenshot
  ...
  alt="Celune agent team cards showing RICK, SAGE, NOIR, SCAN, and DELV with their defined roles, model tiers, and responsibilities"
  width={1200}
  height={750}
  layout="full"
  caption="Every agent gets a structured job description — name, role, model tier, and clear boundaries. This is what it looks like in production."
/>
...
<ProductScreenshot
  ...
  alt="Celune cost analytics showing per-agent token spend broken down by model tier, demonstrating how tiered model assignment controls costs"
  width={1200}
  height={750}
  layout="float-left"
  caption="Tiered model assignment in action — Opus handles architecture, Sonnet handles reviews, Haiku handles research. The cost difference is dramatic."
/>
