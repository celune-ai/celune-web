...
<ProductScreenshot src="/blog/screenshots/task-board.jpg" alt="Celune kanban board with Inbox, In Progress, and Done columns — the visual layer on top of a programmatic task database" width={1200} height={750} layout="full" caption="The Celune task board — a visual dashboard over the same database agents interact with via CLI and API." />
...
<ProductScreenshot src="/blog/screenshots/cost-tracking.jpg" alt="Celune cost analytics dashboard showing per-agent costs, model usage breakdown, and token spend over time" width={1200} height={750} layout="full" caption="Per-agent cost tracking answers the question every AI team needs answered: where are the tokens going?" />
...
<ProductScreenshot src="/blog/screenshots/dashboard.jpg" alt="Celune system dashboard with real-time metrics, charts, and activity feed showing agent task completions" width={1200} height={750} layout="float-left" caption="Real-time dashboards reflect the event stream — every task claim, completion, and status change appears instantly." />
