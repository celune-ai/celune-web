...
<ProductScreenshot
  ...
  alt="Celune agent team configuration showing named agent cards for RICK, SAGE, NOIR, SCAN, and DELV with roles and model assignments"
  width={1200}
  height={750}
  layout="float-right"
  caption="The agent team — five named agents, each with a defined role and model tier."
/>
...
<ProductScreenshot
  ...
  alt="Celune kanban task board with Inbox, In Progress, and Done columns showing real-time task assignments"
  width={1200}
  height={750}
  layout="full"
  caption="Real-time kanban state — every task has a status, assignee, and description. No batch updates, no stale boards."
/>
...
<ProductScreenshot
  ...
  alt="Celune system health dashboard with metrics, charts tracking agent performance, and activity feed"
  width={1200}
  height={750}
  layout="full"
  caption="The system dashboard — monitoring agent performance, token usage, and cache hit rates across the team."
/>
