...
<ProductScreenshot src="/blog/screenshots/agent-config.jpg" alt="Celune agent team configuration showing named agent cards for RICK, SAGE, NOIR, SCAN, and DELV with roles and model assignments" width={1200} height={750} layout="float-right" caption="The agent team — five named agents, each with a defined role and model tier." />
...
<ProductScreenshot src="/blog/screenshots/task-board.jpg" alt="Celune kanban task board with Inbox, In Progress, and Done columns showing real-time task assignments" width={1200} height={750} layout="full" caption="Real-time kanban state — every task has a status, assignee, and description. No batch updates, no stale boards." />
...
<ProductScreenshot src="/blog/screenshots/dashboard.jpg" alt="Celune system health dashboard with metrics, charts tracking agent performance, and activity feed" width={1200} height={750} layout="full" caption="The system dashboard — monitoring agent performance, token usage, and cache hit rates across the team." />
...
_This is the first post on the Celune blog. More on building in public, AI-assisted development, and the studio's approach to product work coming soon._
